...
async function main() {
  ...
  console.log('Seeding rental requests (Permintaan Sewa)...');
  
  // 1. Pending Request (Menunggu)
  ...
  // 2. Validated request waiting for payment
